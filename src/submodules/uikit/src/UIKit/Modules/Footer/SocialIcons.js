...
const socialFacebook = "https://facebook.com/mangarockapp";
const socialTwitter = "https://twitter.com/mangarockapp";
const socialGPlus = "https://plus.google.com/+Mangarockapp";
  ...
  render() {
    ...
    return (
      <div className={cn(s.root, className)} {...otherProps}>
        <Link className={s.link} to={socialFacebook} target="_blank">
          <IconFacebook />
        </Link>
        <Link className={s.link} to={socialTwitter} target="_blank">
          <IconTwitter />
        </Link>
        <Link className={s.link} to={socialGPlus} target="_blank">
          <IconGplus />
        </Link>
      </div>
    );
